...
<SectionHeading label="Overview" title="Audit Metadata" />

<CertBanner
  casino="Duel.com"
  subtitle="Dice Audit Metadata"
  metadataItems={[
    { label: "Audit version", value: "1.0" },
    { label: "Audit date", value: "January 25, 2026" },
    { label: "Repository", value: "https://github.com/ProvablyFair-org/duel-audit" },
    { label: "Commit audited", value: "fa913ab" },
    { label: "Public certification", value: "https://www.provablyfair.org/audits/Duel" },
    { label: "Audit ID", value: "PF-2026-002", tone: "success" },
  ]}
/>
...
<div className="diceAuditOverviewGrid">
  ...
  <section className="diceAuditOverviewCard">
    ...
    <ul>
      ...
      <li>Payout logic and multipliers</li>
      <li>Theoretical RTP target (99.9%)</li>
...
<VerdictTable
  ...
  rows={[
    ...
    },
    {
      ...
      test: "RTP Verified",
      status: "PASS",
      meaning: "99.9% +/-0.1% house edge",
    },
    {
      id: "parity",
      test: "Live to Verifier Parity",
      status: "PASS",
      meaning: "100% all test rounds matched",
    },
    {
      id: "commitReveal",
    ...
    },
    {
      ...
      test: "RNG Analysis",
      status: "PASS",
      meaning: "Unbiased via rejection sampling",
    },
    {
      id: "payout",
      test: "Payout Logic",
      status: "PASS",
      meaning: "All payouts verified correct",
    },
    {
      id: "fairness",
      test: "Fairness Guarantees Tested",
      status: "PASS",
      meaning: "7 of 7 fairness guarantees verified",
    },
    {
      id: "determinism",
      test: "Determinism",
  ...
  rows={[
    {
      ...
      test: "Overall Status",
      status: "PASS",
      meaning: "All audited fairness controls passed across evaluated sections.",
    },
    {
      id: "summary-rtp",
      test: "RTP Verified",
      status: "PASS",
      meaning: "99.9% theoretical RTP (0.1% house edge)",
    },
    {
      id: "summary-parity",
      test: "Live ↔ Verifier Parity",
      status: "PASS",
      meaning: "100% (6,200/6,200 live bets matched)",
    },
    {
      id: "summary-exploits",
      ...
      meaning: (
        <>
          (7/7 categories passed) <a href="#5-fairness-integrity-testing">Section 5</a>
        </>
      ),
    },
  ]}
...
<AuditTimeline
  steps={[
    { title: "Bets verified", date: "6,200" },
    { title: "Matches", date: "6,200 / 6,200" },
    { title: "Mismatches", date: "0" },
